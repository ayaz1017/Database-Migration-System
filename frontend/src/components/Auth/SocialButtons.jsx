  ...
  return (
    <div className="grid grid-cols-2 gap-2.5 w-full">
      <button 
        ...
        className="w-full flex items-center justify-center space-x-2 py-2 px-2.5 bg-white hover:bg-slate-50 border border-slate-200 hover:border-slate-300 rounded-lg transition-all text-xs font-medium text-slate-700 hover:text-slate-900 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer shadow-xs min-w-0"
      >
